...
<body>
<div class="container mt-5"><h1 class="h3 mb-2 text-gray-800">Import Obat Masuk</h1>
	<div class="card">
		...
		<div class="mt-2">
			...
			<form action="<?php echo base_url('importExpire/jumlah');?>" method="post" enctype="multipart/form-data">
